...
export default class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('human_up_1',         'assets/Human/human_up_1.png'); 
        this.load.image('human_up_2',         'assets/Human/human_up_2.png'); 
        ...
        this.load.image('zombie_up_1',         'assets/Zombie/zombie_up_1.png'); 
        this.load.image('zombie_up_2',         'assets/Zombie/zombie_up_2.png'); 
    ...
    update(time, delta) {
        ...
        if ( !this.gameOver && 
            ...
            this.zombieEntity.zombieGridPos.col === this.playerEntity.playerGridPos.col) {
                ...
                this.recorder.finalizeExperiences();
